...
(function() {
  var hasModule, makeTwix, __slice = [].slice,
    __indexOf = [].indexOf ||
  function(item) {
  ...
  makeTwix = function(moment) {
    ...
    Twix = (function() {
      ...
      Twix.prototype._lazyLang = function() {
        var e, lang, langData, _ref, _ref1;
        ...
        return this.langData = (_ref1 = langData != null ? langData._twix : void 0) != null ? _ref1 : Twix.defaults;
      };

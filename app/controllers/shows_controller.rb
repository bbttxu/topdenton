...
class ShowsController < ApplicationController
  ...
  def index
    ...
    @first_show = Show.upcoming.ordered.first
    @last_show = Show.upcoming.ordered.last

    @calendar = (@first_show.starts_at.beginning_of_week.to_date..@last_show.starts_at.end_of_month.to_date)
